...
> Сможете проанализировать этот контейнер с данными?
...
> Мы хотели просто так отдать вам флаг, но у нас есть только архив, а пароль мы забыли.
...
> Пришёл я в магазин с USB-клавиатурой, а она мне как раз!
...
> Пока писал это послание, написал ещё три
...
> Кажется, это точно не шифр Цезаря.
> Итак, у нас есть шфиротекст **hefi{onixsgkjebujxw}**
...
> Мой кот прошелся по клавиатуре. Хотя нет, это точно какой-то шифр
...
> Подсчитаем буквы!
> Формат флага: обернуть найденный текст в flag{}
...
> Эти странные символы похоже из какой-то древней эпохи, возможно 11 - 13 век.
...
>  `37 64 37 39 33 30 33 37 61 30 37 36 30 31 38 36`
>  `35 37 34 62 30 32 38 32 66 32 66 34 33 35 65 37`
...
> Послушай эту запись.
>  **Формат флага: flag{sha1} , всё в lowercase**
